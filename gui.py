...
from PyQt6.QtWidgets import (
    ...
    QComboBox, QTreeView, QDialog, QDialogButtonBox, QMessageBox
)
from PyQt6.QtCore import QThread, pyqtSignal, Qt, QObject
from PyQt6.QtGui import QTextCursor, QStandardItemModel, QStandardItem
    ...
    def run_generation(self, url, repo_id=None):
        try:
            ...
            self.server.handle_request({
                "jsonrpc": "2.0", "id": 3, "method": "index_repo", "params": {"id": self.repo_id}
            })
...
class MainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        self.output_view.setStyleSheet("background-color: #1e1e1e; color: #d4d4d4; font-family: Consolas;")
    ...
    def setup_worker(self):
        ...
        model_path = self.model_dir / "model.onnx" if self.model_dir.exists() else self.model_dir
        tokenizer_path = self.model_dir / "tokenizer.json" if self.model_dir.exists() else self.model_dir
    ...
    def on_finished(self, path):
        ...
        QMessageBox.information(self, "Success", f"Manual generated successfully at:\n{path}")
